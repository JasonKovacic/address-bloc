    ...
    let(:book) { AddressBook.new }
      ...
      context "importing from entries_2.csv" do
          ...
          it "imports the 1st entry" do
              ...
              book.import_from_csv("entries_2.csv")
              entry_one = book.entries[0]
              check_entry(entry_one, "Jason", "415-615-2996", "kovacic.jason@gmail.com")
          end
          ...
          it "imports the 2nd entry" do
              ...
              # Check the second entry
              entry_two = book.entries[1]
              check_entry(entry_two, "Kelsey", "415-615-2996", "kelscs@gmail.com")
          end
          ...
          it "imports the 3rd entry" do
              ...
              # Check the third entry
              entry_three = book.entries[2]
              check_entry(entry_three, "Stephen", "415-407-8907", "heyrelaxguy@gmail.com")
          end
